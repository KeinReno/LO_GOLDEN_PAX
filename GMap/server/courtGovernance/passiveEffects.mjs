/**
 * Scoped NPC passive effects: player-ruler resolution, activeEffects rebuild
 * from traits/postings/seats, and the system/faction-scope consumers.
 *
...
import { npcAvailable, ensureFactionCouncil, isSeatUnlocked, resolveOccupiedSeatBonus } from "./council.mjs";
import { ensureInternalBlocs, recomputeInternalBlocs } from "./blocs.mjs";
