...
import {
  FactionCompareSection,
  InterventionsSection,
  SessionBriefSection,
  DryRunSection,
} from "./gm/GmHealthExtras";
...
type HealthTab = "ops" | "factions" | "brief" | "dryrun" | "interventions";
...
export function OpsHealthPanel({
  ...
  return (
    <section>
      ...
      <div className="gm-court-tabs" role="tablist" aria-label="Health">
        {(
          [
            ["ops", "Тик"],
            ["factions", "Фракции"],
      ...
      {tab === "factions" && <FactionCompareSection />}
      {tab === "brief" && <SessionBriefSection />}
      {tab === "dryrun" && <DryRunSection />}
            ...
            <div className="order-card" style={{ marginTop: 8 }}>
              ...
              <ul className="hint" style={{ paddingLeft: 16 }}>
                <li>
                  ...
                  {tickWhen ?? (
                    <span style={{ color: "#c9a227" }}>
                      никогда — первый boot без catch-up
                    </span>
                  )}
                ...
                <li>
                  ...
                  {backupWhen
                    ? ` · последний ${backupWhen}${
                        health.lastBackupReason
                          ? ` (${backupReasonLabel(health.lastBackupReason)})`
                          : ""
                      }`
                    : " · снимков пока нет"}
                </li>
                ...
                {health.store && (
                  <li>
                    store:{" "}
                    <span
                      style={{ color: health.store.ok ? "#7ec87e" : "#e07070" }}
                    >
                      {health.store.driver}
                    ...
                    {health.store.betterSqlite3 != null && (
                      <span className="hint">
                        {" "}
                        · better-sqlite3:{" "}
                        {health.store.betterSqlite3 ? "да" : "нет"}
                      </span>
                    )}
                  </li>
                )}
          ...
          <div style={{ marginTop: 10 }}>
            ...
            {journal ? (
              <div className="order-card" style={{ marginTop: 6 }}>
                ...
                <span className="hint">
                  {" "}
                  · событий {journal.events?.length ?? 0}
                </span>
