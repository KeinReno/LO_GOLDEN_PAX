...
const NPCS = [
  {
    ...
    gmNotes: "PC / Avis Wintory. Пароль Archon. isPlayerRuler.",
    tags: ["дуализм", "Эланор"],
  ...
  },
  {
    id: "npc_karned_godod",
    name: "Старший Год'од",
    title: "Стратег · военноначальник Эланор",
    role: "strategist",
    status: "active",
    publicNotes:
      "Отвечает за всю расу Эланор в составе государства. Требует аудиенции с глазу на глаз.",
    gmNotes: "Лидер расы Эланор + советник-стратег.",
    tags: ["Год'од", "штаб", "Эланор"],
    councilSeat: "seat.strategist",
    blocId: "bloc.elanor",
    isBlocLeader: true,
    raceLeadership: {
      raceId: "race_elanor",
      title: "Стратег Эланор",
    },
    posting: { kind: "court", sinceTurn: 0 },
  },
  {
    id: "npc_karned_godod_jr",
    name: "Год'од младший",
    title: "Лидер Церкви Чёрного Солнца",
    role: "priest",
    status: "active",
    publicNotes:
      "Брат старшего Год'ода. Глава Церкви Чёрного Солнца — внутренней фракции Карнеда и Эланор.",
    gmNotes: "Клика bloc.black_sun. Не путать со старшим стратегом.",
    tags: ["Год'од", "Черное Солнце", "Эланор"],
    councilSeat: null,
    blocId: "bloc.black_sun",
    isBlocLeader: true,
    posting: { kind: "court", sinceTurn: 0 },
  },
  {
...
const KARNED_BLOCS = [
  {
    ...
    agenda: "stability",
    raceIds: ["race_elanor"],
    description: "Народ Эланор. Военный контур — старший Год'од.",
    leaderNpcId: "npc_karned_godod",
    influence: 0,
    support: 0,
    threat: 0,
  },
  {
    id: "bloc.black_sun",
    name: "Церковь Чёрного Солнца",
    kind: "church",
    color: "#2a2a32",
    stance: "ambitious",
    agenda: "faith",
    raceIds: ["race_elanor"],
    description: "Внутренняя фракция государства и расы. Глава — Год'од младший.",
    leaderNpcId: "npc_karned_godod_jr",
    influence: 0,
    support: 0,
    threat: 0,
  },
  {
    id: "bloc.secret_order",
    name: "Тайный Орден",
    kind: "church",
    color: "#4a3a5c",
    stance: "ambitious",
    agenda: "intrigue",
    description: "Круг Тенепляса.",
    leaderNpcId: "npc_karned_teneplyas",
    influence: 0,
    support: 0,
    threat: 0,
  },
  {
    ...
    stance: "neutral",
    agenda: "trade",
    description: "Полис и камень Гарденис.",
    leaderNpcId: "npc_karned_architect",
    influence: 0,
    support: 0,
    threat: 0,
  },
...
function applyFaction(world) {
  ...
  Object.assign(f, {
    ...
    internalBlocs: KARNED_BLOCS.map((b) => ({ ...b })),
    council: {
      unlockedSeatIds: [
        "seat.ruler",
        "seat.strategist",
