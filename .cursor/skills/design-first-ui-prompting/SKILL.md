...
description: Use when you need design-first, spec-driven, skimmable prompts for UI generation. Covers prompt structure, constraints, variations, typography/spacing rules, and iteration workflow for consistent UI outputs. Applied to LO_GOLDEN_PAX for generating consistent editor/viewer/HUD panels.
---
...
```text
GOAL
- What are we making? (e.g., context card / inspector section / inbox row)
