...
description: Create minimal framed grid layouts with thin visible boundary lines, L-shaped corner brackets, subtle diagonal line texture, and strict section alignment. Use when asked for clean, neutral, precise, structured, editorial, technical, or guide-border layouts. Adapted for LO_GOLDEN_PAX: applies to the panel grid housing Inspector/IntentsInbox/SystemDossier/PlayerHqPanels.
---
...
For LO_GOLDEN_PAX: use as the base layout system for the editor/viewer panel grid. Every docked panel (Inspector, IntentsInbox, SystemDossier, PlayerHqPanels) is a frame in this grid.
