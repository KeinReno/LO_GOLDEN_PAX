...
description: Create a monochrome technical wireframe design system with exploded structure, connector annotations, sparse information labels, and precise dark diagnostic framing. Use for diagnostic/system-dossier views. Adapted for LO_GOLDEN_PAX: applies to SystemDossier.tsx and diagnostic map overlays.
---

# Technical Wireframe Info Layout Skill

## Use When
- Create a monochrome technical wireframe design system with exploded structure, connector annotations, sparse information labels, and precise dark diagnostic framing.
...
For LO_GOLDEN_PAX: use for SystemDossier.tsx and any diagnostic overlay on MapCanvas that explains a system's internals (a planet's economy graph, a faction's AI state, a combat resolution trace).
...
- Use real WebGL, Three.js, SVG, or canvas linework when possible for the wireframe centerpiece instead of flat screenshots or filled 3D renders. For LO_GOLDEN_PAX: prefer SVG/canvas linework to match the existing renderer.
- Build the object from outlined geometry, edges, or modular parts that can separate slightly to suggest a system exploded into readable components.
...
## Avoid
- Filled glossy renders that replace the wireframe diagnostic look.
