...
description: Design, implement, tune, or test readable tactical combat for web games. Use for attack timing, guard and dodge windows, hit contact, posture, lock-on, weapons, boss/capital phases, combat feedback, and deterministic combat tests. Adapted for LO_GOLDEN_PAX: applies to fleet/planet combat resolution in planetActions and intents.
---
