---
name: ship-web-games
description: Package, deploy, and verify a playable web game. Use for release builds, asset delivery, private/public deployment, production smoke tests, browser proof, release notes, rollback readiness, and cleanup of temporary QA resources. Directly applies to LO_GOLDEN_PAX GMap.
---
