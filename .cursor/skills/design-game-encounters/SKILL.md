...
description: Design, implement, tune, or test game encounters. Use for arena/map layout, enemy/faction composition, spawn pacing, objectives, boss/capital phases, reward cadence, encounter fixtures, and difficulty validation. Adapted for LO_GOLDEN_PAX: applies to fleet clashes, planet sieges, faction pressure events, and planetActions.
---
