...
preamble-tier: 2
---
<!-- Vendored from https://github.com/fagemx/gstack-game (MIT License, Copyright (c) 2026 fagemx), skills/game-ux-review/SKILL.md. See NOTICE.md in this folder. -->
...
This skill reviews UI/UX design and implementation. It can review mockups, wireframes, live builds, or screenshots. For GDD review, use `/game-review`. For visual QA (bug-finding), use `/game-visual-qa` (not vendored in this project — skip if unavailable).
...
## Section 1: First Impression — Weight: varies by mode
...
## Section 2: HUD Review — Weight: varies by mode
...
## Section 3: Menu Flow — Weight: varies by mode
...
## Section 4: Shop / Monetization UI — Weight: varies by mode
...
## Section 5: Tutorial / Onboarding UI — Weight: varies by mode
...
## Section 6: Input Adaptation — Weight: varies by mode
...
## Section 7: Accessibility — Weight: varies by mode
...
## Section 8: Cross-Screen Consistency — Weight: varies by mode
