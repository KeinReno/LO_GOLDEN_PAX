/**
 * Biome / planet-type gates for buildings with biome_restrictions. Ported
 * verbatim from GMap/server/biomeMatch.mjs — already pure. Parity verified
 * in biomeMatch.parity.test.mjs.
 */
export function planetMatchesBiome(planet, restriction) {
  ...
  if (r === "volcanic" && (climate === "infernal" || climate === "hot" || type === "volcanic")) return true;
